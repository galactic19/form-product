...
export function HeroSection() {
  return (
    <section id="hero" className="relative overflow-hidden px-6 py-32 sm:py-48 lg:py-56">
      {/* Dynamic Background */}
      ...
      <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2 lg:items-center">
        <div className="relative z-10">
          ...
          <SplitText
            ...
            className="text-5xl font-bold leading-tight tracking-tight text-foreground sm:text-7xl lg:text-8xl drop-shadow-2xl"
          />
        ...
        <div className="relative lg:h-[600px] flex items-center justify-center">
          <RevealOnScroll direction="left" delay={0.2} className="relative w-full max-w-[400px]">
            ...
            {/* Floating Elements */}
            <div className="absolute -right-12 top-20 rounded-2xl border border-border/50 bg-card/80 p-4 backdrop-blur-xl shadow-xl animate-float duration-[5000ms]">
            ...
            <div className="absolute -left-8 bottom-32 rounded-2xl border border-border/50 bg-card/80 p-4 backdrop-blur-xl shadow-xl animate-float delay-700 duration-[6000ms]">
              <div className="flex items-center gap-3">
