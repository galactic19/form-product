        ...
        <RevealOnScroll delay={0.2}>
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-center">
            <MagneticButton
              ...
              className="border-2 border-primary bg-primary px-8 py-4 text-base font-semibold text-primary-foreground transition-all hover:bg-transparent hover:text-primary"
            >
              {finalCTAContent.cta.primary.text}
            </MagneticButton>
            <MagneticButton
              href={finalCTAContent.cta.secondary.href}
              className="border-2 border-foreground px-8 py-4 text-base font-semibold transition-all hover:bg-foreground hover:text-background"
            >
