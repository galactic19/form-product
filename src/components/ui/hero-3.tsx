...
const ActionButton = ({ children }: { children: React.ReactNode }) => (
  <motion.button
    ...
    whileTap={{ scale: 0.95 }}
    className="mt-8 rounded-full bg-[#E8522A] px-8 py-3 font-semibold text-white shadow-lg transition-colors hover:bg-[#D44820] focus:outline-none focus:ring-2 focus:ring-[#E8522A] focus:ring-opacity-75"
  >
    {children}
  </motion.button>
)
